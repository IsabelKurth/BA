...
AL_combined_data_satellite = pd.merge(al_satellite_data, al_water, how="left", on=['DHSID_EA'])
AL_combined_data_street = pd.merge(al_street_data, al_water, how="left", on=['DHSID_EA'])
